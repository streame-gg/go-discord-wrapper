...
> **Note:** Bug fixes referenced in source comments as "Bug 1–50" pre-date systematic
> changelog maintenance and are not exhaustively listed here. The CHANGELOG is maintained
> systematically starting from v0.2.0.
