...
func (s *eventRegistrationSuite) TestRegisterAllHandlers() {
	...
	c.OnGuildIntegrationsUpdate(func(*Client, *events.GuildIntegrationsUpdateEvent) {})
	c.OnWebhooksUpdate(func(*Client, *events.WebhooksUpdateEvent) {})
	c.OnWebhookCreate(func(*Client, *events.WebhookCreateEvent) {})
	c.OnWebhookUpdate(func(*Client, *events.WebhookUpdateEvent) {})
	c.OnWebhookDelete(func(*Client, *events.WebhookDeleteEvent) {})
