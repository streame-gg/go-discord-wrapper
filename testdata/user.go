...
func NewGuildMembersChunkEventPayload() map[string]interface{} {
	return map[string]interface{}{
		...
		"not_found": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]interface{}) {
			*arrayToFill = append(*arrayToFill, testutil.RandomString(testutil.RandomIntInRange(1, 5)))
		}),
		"presences": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]interface{}) {
			*arrayToFill = append(*arrayToFill, NewPresence())
		}),
		"nonce": testutil.RandomString(32),
		"members": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]interface{}) {
...
func NewPresence() map[string]interface{} {
	return map[string]interface{}{
		...
		"activities": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]interface{}) {
...
func NewApplication() map[string]interface{} {
	return map[string]interface{}{
		...
		"team": map[string]interface{}{
			...
			"id":            discord.RandomSnowflake(),
			"members": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]map[string]interface{}) {
		...
		"flags_new": testutil.RandomFlagsAsString(
			discord.ApplicationFlagApplicationAutoModerationRuleCreateBadge,
			discord.ApplicationFlagGatewayPresence,
			discord.ApplicationFlagGatewayPresenceLimited,
			discord.ApplicationFlagGatewayGuildMembers,
		...
		"approximate_user_install_count":       testutil.RandomIntInRange(1, 1000000),
		...
		"integration_types_config": map[discord.ApplicationIntegrationType]map[string]interface{}{
			discord.ApplicationIntegrationTypeGuildInstall: {
				"oauth2_install_params": map[string]interface{}{
					"permissions": testutil.RandomFlags(testutil.AllPermissions...),
					"scopes": testutil.RandomArrayWithFilledItems(testutil.RandomIntInRange(1, 3), func(arrayToFill *[]discord.Scope) {
						*arrayToFill = append(*arrayToFill, testutil.RandomItem(
							discord.ScopeActivitiesRead,
