...
func (s *responsesSuite) compareUser(expected map[string]interface{}, actual discord.User) {
	s.T().Helper()
...
func (s *responsesSuite) compareChannel(expected map[string]interface{}, actual discord.Channel) {
	s.EqualValues(expected["id"], actual.ID)
...
func (s *responsesSuite) compareMember(expected map[string]interface{}, actual discord.GuildMember) {
	s.EqualValues(expected["avatar"], *actual.Avatar)
	s.EqualValues(expected["banner"], *actual.Banner)
...
func (s *responsesSuite) compareRole(expected map[string]interface{}, actual discord.Role) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["name"], actual.Name)
...
func (s *responsesSuite) resolveNullFlag(input interface{}) interface{} {
	if input == nil {
...
func (s *responsesSuite) compareSticker(expected map[string]interface{}, actual discord.Sticker) {
	s.EqualValues(expected["id"], actual.ID)
...
func (s *responsesSuite) compareEmoji(expected map[string]interface{}, actual discord.Emoji) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["name"], actual.Name)
	s.EqualValues(expected["roles"], *actual.Roles)
...
func (s *responsesSuite) comparePresence(expected map[string]interface{}, actual discord.Presence) {
	s.compareUser(expected["user"].(map[string]interface{}), actual.User)
...
func (s *responsesSuite) compareGuildScheduledEvent(expected map[string]interface{}, actual discord.GuildScheduledEvent) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["guild_id"], actual.GuildID)
...
func (s *responsesSuite) compareGuild(expected map[string]interface{}, actual discord.Guild) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["name"], actual.Name)
	s.EqualValues(expected["icon"], *actual.Icon)
...
func (s *responsesSuite) compareSoundboardSound(expected map[string]interface{}, actual discord.SoundboardSound) {
	s.EqualValues(expected["name"], actual.Name)
...
func (s *responsesSuite) compareStageInstance(expected map[string]interface{}, actual discord.StageInstance) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["guild_id"], actual.GuildID)
	s.EqualValues(expected["channel_id"], actual.ChannelID)
	s.EqualValues(expected["topic"], actual.Topic)
...
func (s *responsesSuite) compareVoiceState(expected map[string]interface{}, actual discord.VoiceState) {
	s.EqualValues(expected["guild_id"], *actual.GuildID)
	s.EqualValues(expected["channel_id"], *actual.ChannelID)
...
func (s *responsesSuite) compareIntegration(expected map[string]interface{}, actual discord.Integration) {
...
func (s *responsesSuite) compareThreadMember(expected map[string]interface{}, actual discord.ThreadMember) {
	s.EqualValues(expected["id"], *actual.ID)
	s.EqualValues(expected["user_id"], *actual.UserID)
...
func (s *responsesSuite) compareSubscription(expected map[string]interface{}, actual discord.Subscription) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["user_id"], actual.UserID)
...
func (s *responsesSuite) compareEntitlement(expected map[string]interface{}, actual discord.Entitlement) {
	s.EqualValues(expected["id"], actual.ID)
...
func (s *responsesSuite) compareResolved(expected map[string]interface{}, actual discord.ResolvedData) {
...
func (s *responsesSuite) compareAttachment(expected map[string]interface{}, actual discord.Attachment) {
	s.EqualValues(expected["id"], actual.ID)
...
func (s *responsesSuite) compareApplication(expected map[string]interface{}, actual discord.Application) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["name"], actual.Name)
	s.EqualValues(expected["icon"], *actual.Icon)
	s.EqualValues(expected["description"], actual.Description)
...
func (s *responsesSuite) compareMessage(expected map[string]interface{}, actual discord.Message) {
	s.EqualValues(expected["id"], actual.ID)
	s.EqualValues(expected["channel_id"], actual.ChannelID)
...
func (s *responsesSuite) compareMessageInteractionMetadata(expected map[string]interface{}, actual discord.AnyMessageInteractionMetadata) {
	switch actual.(type) {
...
func (s *responsesSuite) expectMap(expected map[string]interface{}, key string) map[string]interface{} {
	s.T().Helper()
...
func (s *responsesSuite) compareInteractionData(expected map[string]interface{}, raw discord.InteractionData) {
	switch raw.GetType() {
	case discord.InteractionTypeApplicationCommand:
		actual := raw.(*InteractionDataApplicationCommand)
	...
	case discord.InteractionTypeMessageComponent:
		actual := raw.(*InteractionDataMessageComponent)
	...
	case discord.InteractionTypeApplicationCommandAutocomplete:
		actual := raw.(*InteractionDataAutocomplete)
	...
	case discord.InteractionTypeModalSubmit:
		actual := raw.(*InteractionDataModalSubmit)
...
func (s *responsesSuite) compareApplicationCommandInteractionDataOption(expected map[string]interface{}, actual ApplicationCommandInteractionDataOption[interface{}]) {
	s.EqualValues(expected["name"], actual.Name)
	s.EqualValues(expected["type"], actual.Type)
...
func (s *responsesSuite) compareComponentLabelChild(expected map[string]interface{}, actual components.AnyComponentInteractionResponse) {
...
func (s *responsesSuite) compareReaction(expected map[string]interface{}, actual discord.Reaction) {
...
func (s *responsesSuite) compareEmbed(expected map[string]interface{}, actual discord.Embed) {
	s.EqualValues(expected["title"], actual.Title)
	s.EqualValues(expected["type"], actual.Type)
	s.EqualValues(expected["description"], actual.Description)
	s.EqualValues(expected["url"], actual.URL)
...
func (s *responsesSuite) compareComponent(expected map[string]interface{}, actual discord.AnyComponent) {
	s.T().Helper()
...
func (s *responsesSuite) compareUnfurledMediaItem(expected map[string]interface{}, actual components.UnfurledMediaItem) {
	s.EqualValues(expected["url"], actual.URL)
	s.EqualValues(expected["proxy_url"], actual.ProxyURL)
	s.EqualValues(expected["height"], *actual.Height)
	s.EqualValues(expected["width"], *actual.Width)
...
func (s *responsesSuite) compareDefaultValues(expected []map[string]interface{}, actual []components.SelectDefaultValue) {
...
func (s *responsesSuite) TestInteractionResponseDataDefault() {
	sub := testutil.InitSub[InteractionResponseDataDefault](s)

	sub.RunCommonEdgeCases()

	payload := InteractionResponseDataDefault{
		TTS:     discord.Some(false),
		Content: discord.Null[string](),
		Embeds:  discord.None[[]discord.Embed](),
	}

	sub.RunCases([]testutil.UnmarshalTestCase[InteractionResponseDataDefault]{
		{
			Name:  "unmarshal valid full payload",
			Input: sub.MustMarshal(payload),
			Validate: func(got InteractionResponseDataDefault) {
				s.False(payload.TTS.MustVal())
				s.False(got.TTS.MustVal())

				s.Equal(payload.Content.IsNull(), got.Content.IsNull())
				s.Equal(payload.Embeds.IsZero(), got.Embeds.IsZero())
